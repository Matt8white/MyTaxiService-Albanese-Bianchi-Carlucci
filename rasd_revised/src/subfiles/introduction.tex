...
The prime stakeholder on the supply side is the \textbf{government}, whose aim is to expand and simplify its taxi service in order to make it more easy and immediate to use and also to save public money by tightening the reservation process.

Another supply-side stakeholders are \textbf{taxi drivers} whose right amount of work will be guaranteed and communication with citizens will be improved.

On the demand side, the prime stakeholders are \textbf{citizens}. Their taxi experience will be enhanced using all the platform's functionalities and services.
