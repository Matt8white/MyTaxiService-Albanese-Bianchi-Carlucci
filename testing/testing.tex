...
% === OTHERS ===
\testx{TaxiDriverManager - ???}{TaxiDriverManager}{Taxi}{??}{??}{??}{???}

\testx{TaxiHandler - ???}{TaxiHandler}{Taxi}{??}{??}{??}{???}

\testx{TaxiHandler - ???}{TaxiHandler}{TaxiHandler}{??}{??}{??}{???}

\testx{RideManager - ???}{RideManager}{Ride}{??}{??}{??}{???}
