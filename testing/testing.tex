...
\subsection{Purpose} 
\label{sub:purpose}
The purpose of this document, Integration Test Plan Document (ITPD), is to describe how integration tests are to be performed. In particular, it describes the adopted methodologies, 
