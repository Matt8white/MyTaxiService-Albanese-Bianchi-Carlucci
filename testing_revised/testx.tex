...
Please note that the actual access to the DB is done by the corresponding DAO for each Entity Bean. In order to avoid further complexity, the following tests are simplified by considering the entity as the object doing operations on the DB. % (fold)
