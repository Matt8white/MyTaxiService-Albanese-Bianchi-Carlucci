...
%chiunque abbia a che vedere con la piattaforma: città, cittadini, tassisti,
...
\subsubsection{Definitions}
	\begin{itemize}
		...
		\item \textbf{Zone}: area of approximately 2 mq\textsuperscript{2}. The city is partitioned into several zones, each of which are covered by at most a taxi.
