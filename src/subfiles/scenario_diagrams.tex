...
%problema \includegraphics[scale=0.5]{UseCase.png.png}
\pagebreak
...
% SEQUENCE 
\pagebreak
%problema \includegraphics[scale=0.5]{SequenceSignUp.png}
...
% SEQUENCE 
\pagebreak
%problema \includegraphics[scale=0.5]{SequenceSignIn.png}
...
% SEQUENCE 
\pagebreak
%problema \includegraphics[scale=0.5]{SequenceReservation.png}
...
% SEQUENCE 
\pagebreak
%problema \includegraphics[scale=0.5]{SequenceRequestTaxi.png}
...
% SEQUENCE 
\pagebreak
%problema \includegraphics[scale=0.5]{SequenceAllocateTaxi.png}
